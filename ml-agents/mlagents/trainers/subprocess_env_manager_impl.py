...
from mlagents_envs.python_environment import PythonEnvironment
...
def worker(
    ...
    env_factory: Callable[
        [int, List[SideChannel]], PythonEnvironment
